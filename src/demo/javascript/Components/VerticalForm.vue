    ...
    <form @submit.prevent="(e) => {}">
        <div class="flex flex-wrap items-start -mx-2 mb-6">
            <div class="w-full md:w-1/2 px-2">
                <label class="inline-block font-semibold mb-4 md:mt-2" for="full_name2">Full name</label>
            </div>
            ...
            <div class="w-full md:w-1/2 px-2">
                <label class="inline-block font-semibold mb-4 md:mt-2" for="email2">Email</label>
            </div>
            <div class="w-full md:w-1/2 px-2 mb-2">
