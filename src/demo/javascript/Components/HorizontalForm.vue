<template>
    <form @submit.prevent="(e) => {}">
        <div class="flex flex-wrap -mx-2 mb-6">
            ...
            <div class="w-full md:w-1/2 px-2 mb-2 md:mb-4">
            ...
            <div class="w-full md:w-1/2 px-2 mb-2">
                <label class="inline-block font-semibold mb-4" for="profile_image">Profile image</label>
                <div class="file">
            ...
            <div class="w-full md:w-1/2 px-2 mb-2">
                <label class="inline-block font-semibold mb-4" for="country">Country</label>
            ...
            <div class="w-full md:w-1/2 px-2 mb-2 md:mb-0">
                <label class="inline-block font-semibold mb-4" for="bio">Tell us more about you</label>
                <textarea class="block w-full appearance-none bg-white text-lg leading-tight rounded focus:outline-none border border-solid border-gray-400 hover:border-gray-300 focus:border-gray-500 py-2 px-3 mb-2" id="bio"></textarea>
            </div>
            <div class="w-full md:w-1/2 px-2">
                <label class="inline-block font-semibold mb-4" for="favorite_fruit">What's your favorite fruit?</label>
